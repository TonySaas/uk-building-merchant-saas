...
export default function ThemeAwareSidebarNavItem({
  title,
  icon,
  path,
  badge,
  ...
  const itemContent = (
    <>
      <div
        className={cn(
          "flex h-9 w-full items-center gap-2 rounded-md px-3 py-2 transition-colors",
      ...
      {!expanded && (
        <div
          className={cn(
            "absolute left-full ml-2 w-auto min-w-[180px] rounded-md border bg-popover p-2 text-popover-foreground shadow-md dark:bg-popover dark:text-popover-foreground dark:border-border",

...
import SidebarNavItem from "@/polymet/components/sidebar-nav-item";
...
export default function SidebarNavigation({
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-40 flex flex-col border-r border-border bg-background transition-all duration-300 ease-in-out",
          expanded ? "w-64" : "w-16",

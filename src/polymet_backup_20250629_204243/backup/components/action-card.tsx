...
export interface ActionCardProps {
  ...
  className?: string;
  color?: "default" | "primary" | "blue" | "green" | "red" | "orange" | "purple";
}
...
export default function ActionCard({
  ...
  const colorStyles = {
    ...
    orange: "bg-orange-50 border-orange-200 dark:bg-orange-950/30 dark:border-orange-900",
  ...
  return (
    <Card className={cn("border overflow-hidden", colorStyles[color], className)}>
